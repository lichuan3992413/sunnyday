...
public class SignInfoForm extends BaseBean implements Serializable {
	...
	public String toString() {
		return "SignInfoForm [sn=" + sn + ", user_id=" + user_id
				+ ", sp_number=" + sp_number + ", sign_chs=" + sign_chs
				+ ", sign_eng=" + sign_eng + ", status=" + status
				+ ", is_add_msg=" + is_add_msg + ", gate_sp_number="
				+ gate_sp_number + ", td_code=" + td_code + ", insert_time="
				+ insert_time + ", update_time=" + update_time + ", operator="
				+ operator + ", flag=" + flag + ", add_chs_msg=" + add_chs_msg
				+ ", add_eng_msg=" + add_eng_msg + ", is_add_msg_use="
				+ is_add_msg_use + ", unsubscribe_msg=" + unsubscribe_msg + "]";
	}
