 ...
 */
@Service
public class DeliverServiceImpl implements ISmsService{
	...
	public HSResponse doSomething(CommonParameter param) {
		...
		if (list!=null&&list.size()<=0) {
			//LogUtil.writeReceiverLog(corp_id, corp_pwd,requestIP,"0", "尚无上行信息产生",TYPE);
			return  new HSResponse(ErrorCodeUtil.NO_DELIVERS,"尚无上行信息产生");
		} else {
